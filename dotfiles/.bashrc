...
alias aws='{ { source ../../install/setup.bash &> /dev/null || source ../install/setup.bash &> /dev/null || source ./install/setup.bash &> /dev/null || source ./ros2_ws/install/setup.bash &> /dev/null || source ../../devel/setup.bash &> /dev/null || source ../devel/setup.bash &> /dev/null || source ./devel/setup.bash &> /dev/null || source ./catkin_ws/devel/setup.bash &> /dev/null ; } && echo Workspace sourced successfully ; } || echo Error sourcing Workspace'
...
source source ../../install/setup.bash &>/dev/null || source ../install/setup.bash &>/dev/null || source ./install/setup.bash &>/dev/null || source ./ros2_ws/install/setup.bash &>/dev/null || source ../../devel/setup.bash &>/dev/null || source ../devel/setup.bash &>/dev/null || source ./devel/setup.bash &>/dev/null || source ./catkin_ws/devel/setup.bash &>/dev/null
